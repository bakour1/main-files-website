  ...
  const data = {
    ...
    webApp: {
      ...
      webApp_4: {
        ...
        web: "/apps/memory-game",
        album: [ '/imgs/webApp_4-1.webp', '/imgs/webApp_4-2.webp' ],
      },
      webApp_5: {
        title: 'Dashboard Elzero',
        category: 'webApp',
        brief: "ford project frontEnd with Elzero Web School",
        date: "2022",
        client: "none",
        tools: [ "HTML", "created library" ],
        src: "https://github.com/bakour1/dashboard-elzero-by-bakkour-library",
        web: "https://bakour1.github.io/dashboard-elzero-by-bakkour-library/",
        album: [ '/imgs/webApp_5-1.webp', '/imgs/webApp_5-2.webp', '/imgs/webApp_5-3.webp', '/imgs/webApp_5-4.webp', '/imgs/webApp_5-5.webp', '/imgs/webApp_5-6.webp', '/imgs/webApp_5-7.webp', , '/imgs/webApp_5-8.webp' ],
      },
    },
    challenges: {
      challenge_1: {
